...
{ 
	...
	function shorten( $url_long ) 
	{ 
		$params = array();
		$params['url_long'] = urlencode($url_long);
		$params['access_token'] = $this->access_token;
		return $this->get( 'short_url/shorten', $params );
	}
	
	function short_comments( $url_short, $since_id ) 
	{ 
		$params = array();
		$params['url_short'] = urlencode($url_short);
		$params['access_token'] = $this->access_token;
		$params['since_id'] = $since_id;
		return $this->get( 'short_url/comment/comments', $params );
	}
