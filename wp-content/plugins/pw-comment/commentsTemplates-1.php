...
function buildCommentHTML(commentID){
	...
	return '<div id="c-' + commentID + '" class="dl_post" style="display:none"><div class="dl_post_main"><div class="dl_post_avatar"><img alt="" src="'+
			...
			'<a rel="nofollow" target="_parent" data-author="' + usrInfo.screen_name + '" class="comment-reply-link" href="#respond" onclick="return moveForm1(this, ' + commentID + ')">回复</a>' + 
...
function newcomment(sinaid)
{
	...
	$.ajax({
		...
		success: function(result) {
			...
			$("label#commenttext_error").text('DB result: ' + result).show().focus();
			...
			<div class="dl_textarea_jiao"></div>
				...
				<div class="dl_textarea_tool layout">
					<div class="dl_tool_submit">
						<a class="dl_submit_btn" target="_parent" href="javascript:;" onclick="currentParentComment = 0; publish();">发布评论</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="dl_post_control layout">
					...
					<ul class="dl_post_function">
						<li class="dl_function_reply"  style="padding-top:0px; border-top:none">
							<span></span>
							<a rel="nofollow" target="_parent" data-author="<?php comment_author(); ?>" class="comment-reply-link" href="<?php the_permalink( ); ?>#respond" onclick='return moveForm1(this,<?php echo $tt->comment_ID; ?>);'>回复</a>
						</li>
					</ul>
				</div>
			</div>
...
<div id="response" class="dl_publish_textarea" class="dl_reply" style="display: none;">
	...
	<div class="dl_textarea">
		...
		<div class="dl_textarea_tool layout">
			<div class="dl_tool_submit">		
				<a class="dl_submit_btn" href="javascript:;" onclick="return publish();">立即回复</a>
			</div>
		</div>
	</div>
</div>
