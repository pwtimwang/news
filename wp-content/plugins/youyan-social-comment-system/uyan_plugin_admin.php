<div style="margin:10px 15px 0;  background:#FFFFFF; border-bottom:1px solid #cdcdcd; padding-bottom:5px;"><a href="http://www.uyan.cc" target="_blank"><img src="../wp-content/plugins/youyan-social-comment-system/images/uyancc.png"></a></div>
<?php
