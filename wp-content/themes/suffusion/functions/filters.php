...
//Tim added.
function suffusion_share1($output)
{
	global $post;
	$share_str = <<<test
	<!-- Baidu Button BEGIN -->
<div id="bdshare" class="bdshare_t bds_tools get-codes-bdshare" style="clear: left">
    <a class="bds_qzone"></a>
    <a class="bds_tsina"></a>
    <a class="bds_tqq"></a>
...
<script type="text/javascript">
	var bds_config = {'bdText':'$post->post_title  via @wperi'};
...
<div id="ckepop" onmouseover="setShare('$post->post_title via @创业妖','$post->guid', '$excerpt_image')" style="clear: both">
