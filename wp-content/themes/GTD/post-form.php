...
<div id="postbox">
	<form id="new_post" name="new_post" method="post" action="<?php bloginfo( 'url' ); ?>/" >
		...
		<div class="inputarea">
			<label for="posttitile"><?php printf( __('Hi, %s. Whatcha up to?', 'p2'), wp_specialchars( $name ) ) ?></label>
			<div>
			<label>Title</label>
				<textarea name="posttitile" id="posttitile" tabindex="1" rows="1" cols="60"></textarea>
			</div>
...
<label>SourceLink</label>
		<textarea name="sourcelink" id="sourcelink" tabindex="1" rows="1" cols="60"></textarea>
