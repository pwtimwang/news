...
<link rel="stylesheet" type="text/css" href="http://localhost/wp-content/themes/GTD/weiboShow.css">
<link rel="stylesheet" type="text/css" href="http://localhost/wp-content/themes/GTD/skin_default.css">
<base target=_blank />
<script type="text/javascript" src="http://localhost/wp-includes/js/jquery/jquery.js?ver=1.7.1"></script>
<script type="text/javascript" src="http://localhost/wp-includes/js/jquery/jquery-1.6.1.min.js?ver=3.4.2"></script>
<script type="text/javascript" src="http://localhost/wp-includes/js/jquery/jquery.masonry.min.js?ver=3.4.2"></script>
<script type="text/javascript" src="http://localhost/wp-includes/js/jquery/jquery-ui.custom.min.js?ver=3.4.2"></script>
<script type="text/javascript" src="http://localhost/wp-includes/js/jquery/bxCarousel.js"></script>
<style type="text/css">
...
<wb:login-button type="3,2" onlogin="login" onlogout="logout">登录按钮</wb:login-button>
  ...
  <div class="weiboShow_wrap"> 
    ...
    <div class="weiboShow_title weiboShow_title_top"> 
      <!-- logo -->
      <div class="weiboShow_title_logo" id="weibo_title"><a href="http://pingwest.us" target="_blank">
	  <em class="WB_logo16a" title="PingWest快讯">PingWest快讯</em><span style="font-size:13px;color:black;">PingWest快讯</span></a></div>
      <!-- /logo --> 
    </div>
    <!-- /标题 置顶 --> 
...
<p class="weiboShow_mainFeed_listContent_txt">
	...
	<a title="<?php the_title(); ?>"><?php echo '【'.($post->post_title).'】'; ?> <?php echo ($post->post_content); ?></a>

</p>
<p class="weiboShow_mainFeed_listContent_action WB_linkB"><span class="weiboShow_mainFeed_listContent_actionTime"><a href="#" target="_blank">
